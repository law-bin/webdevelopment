...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM requests WHERE id = $delete_id";
    $delete_result = mysqli_query($dbc, $delete_query);

    if ($delete_result) {
        header("Location: requests.php"); // Refresh the page after deletion
        exit();
    } else {
...
<body>
    <div style="padding-top: 120px;">
        <h2>Event Requests</h2> <!-- Header moved outside of the container -->
    </div>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href='requests.php?delete_id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
